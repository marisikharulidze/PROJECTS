    ...
    <center>
        <div class="container">
            ...
            @foreach ($posts as $post)
                <a href="{{ url('/posts' . '/' . $post->id) . '/' . 'delete'}}" >{{$post->mdebareoba}}</a>
                <label> | </label>

                <a href="{{ url('/posts' . '/' . $post->id) . '/' . 'delete'}}" >{{$post->otaxis_raodenoba}}</a>
                <label> | </label>

                <a href="{{ url('/posts' . '/' . $post->id) . '/' . 'delete'}}" >{{$post->tarigi}}</a>
                <label> | </label>

                <a href="{{ url('/posts' . '/' . $post->id) . '/' . 'delete'}}" >{{$post->fartobi}}</a>
                <label> | </label>
                
                <a href="{{ url('/posts' . '/' . $post->id) . '/' . 'delete'}}" >{{$post->fasi}}</a>
