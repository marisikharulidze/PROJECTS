...
<body>
    <header>
        ...
        <a href="welcome.php" class="welcome" name="welcome">Shop Online <div></div> Without Leaving Home</a>
    ...
    <div style="padding: 12px 15px">
        <a href="{{ url('/dresses') }}"><div style="background-image: url(pic/4.jpg);" class="img"></div></a>
        <a href="{{ url('/') }}"><div style="background-image: url(pic/6.jpg); left:490px" class="img"></div></a>
        <a href="{{ url('/') }}"><div style="background-image: url(pic/5.jpg); left:970px" class="img"></div></a>
        <br>
        <h1 style="position: absolute;top:1350px;left:33px;color:white">Dresses <hr> </h1>
        <h1 style="position: absolute;top:1350px;left:510px;color:white">Coats <hr> </h1>
        <h1 style="position: absolute;top:1350px;left:990px;color:white">accessories <hr> </h1>
        <br>
        <br>
        <br>
    </div>
